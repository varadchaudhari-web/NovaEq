...
export const mockCourses: Course[] = [
  { id: 'cr001', title: 'Stock Market Fundamentals', description: 'Master the basics of stock market investing — from understanding equities to portfolio construction.', instructor: 'Marcus Chen', duration: '8h 30m', level: 'beginner', enrolled: 12840, rating: 4.8, thumbnail: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&h=340&fit=crop', progress: 65, lessons: 24, category: 'Investing', isEnrolled: true },
  { id: 'cr002', title: 'Technical Analysis Masterclass', description: 'Advanced charting patterns, indicators, and price action strategies used by professional traders.', instructor: 'Priya Sharma', duration: '12h 15m', level: 'advanced', enrolled: 8930, rating: 4.9, thumbnail: 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?w=600&h=340&fit=crop', progress: 30, lessons: 36, category: 'Trading', isEnrolled: true },
  { id: 'cr003', title: 'Algorithmic Trading with Python', description: 'Build and deploy automated trading strategies using Python, backtrader, and quantitative methods.', instructor: 'Priya Sharma', duration: '16h 45m', level: 'advanced', enrolled: 6280, rating: 4.7, thumbnail: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=600&h=340&fit=crop', progress: 0, lessons: 48, category: 'Algo Trading', isEnrolled: false },
  { id: 'cr004', title: 'Options & Derivatives 101', description: 'Learn options strategies including covered calls, protective puts, spreads, and the Greeks.', instructor: 'Marcus Chen', duration: '10h 20m', level: 'intermediate', enrolled: 9450, rating: 4.6, thumbnail: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=340&fit=crop', progress: 0, lessons: 32, category: 'Derivatives', isEnrolled: false },
  { id: 'cr005', title: 'Financial Planning & Wealth Management', description: 'Comprehensive guide to personal finance, tax optimization, and long-term wealth building strategies.', instructor: 'Marcus Chen', duration: '6h 45m', level: 'beginner', enrolled: 15670, rating: 4.8, thumbnail: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=340&fit=crop', progress: 100, lessons: 20, category: 'Wealth Management', isEnrolled: true },
  { id: 'cr006', title: 'Crypto & DeFi Investing', description: 'Navigate the cryptocurrency ecosystem, DeFi protocols, and blockchain-based investment vehicles.', instructor: 'Jordan Liu', duration: '9h 10m', level: 'intermediate', enrolled: 11200, rating: 4.5, thumbnail: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=600&h=340&fit=crop', progress: 0, lessons: 28, category: 'Crypto', isEnrolled: false },
];
